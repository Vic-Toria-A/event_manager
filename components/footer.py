...
def show_footer():
    ...
    with ui.element("footer").classes(
        "w-full h-[300px] bg-blue-900 items-center justify-center px-10 py-5 rounded-b-lg"
    ):
        ...
        with ui.row().classes("items-center justify-center text-white mb-8 gap-5"):
            ...
            ui.input(placeholder="Enter your mail").props("outlined no-caps").classes("bg-white w-64 rounded-md")
            ui.button("Subscribe").props("flat dense no-caps").classes("px-20 py-4 bg-purple-600 text-white")
        ...
        with ui.element("div").classes(
            ...
            with ui.row():
                ui.html("<p>Non Copyrighted &copy; 2025 Upload by rich technologies</p>")